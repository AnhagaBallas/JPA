...
public class HibernateServiceImpl implements HibernateService {
    ...
    @Override
    public List<PersonalData> getByAge(String age) {
        return hibernateRepository.findPersonByAge(age);
    }

    @Override
    public List<PersonalData> getByNameSurname(String name, String surname) {
